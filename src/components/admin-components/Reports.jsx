    ...
    <Container>
      {
        ...
        <ReportView> 
          ...
          {toGenerate.destinationv && <DestinationsAnalytics />}
      ...
      <Header>
        <Title><h1>Overview</h1> <p>Explore the latest of Tourism Performance in Iloilo City</p></Title>
        <Profile>
          <Frame></Frame>
      ...
      <ReportChecking>
        <CheckBoxes>
          <Info>Customize your report</Info>
          <div>
          ...
          <div>
            <CheckBox type="checkbox" onChange={(value) => { reports.destinationv = value.target.checked; console.log(reports) }} />
            <Label>Iloilo Tourism Destination Responses</Label>
          </div>
          <div>
